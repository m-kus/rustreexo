...
#[no_mangle]
pub extern "C" fn rustreexo_stump_create(errno: *mut Error, stump: *mut *mut Stump) -> usize {
    check_ptr!(errno);
    check_ptr!(errno, stump);
    unsafe {
...
#[no_mangle]
pub extern "C" fn rustreexo_stump_free(errno: *mut Error, stump: *mut Stump) -> usize {
    check_ptr!(errno);
    check_ptr!(errno, stump);
    unsafe {
...
#[no_mangle]
pub extern "C" fn rustreexo_stump_get_roots(
    errno: *mut Error,
    ret: *mut *mut CHash,
    ret_len: *mut usize,
    stump: *mut Stump,
...
#[no_mangle]
pub extern "C" fn rustreexo_stump_roots_free(errno: *mut Error, roots: *mut CHash) -> usize {
    check_ptr!(errno);
